...
CMD ["gunicorn", "--workers", "1", "--bind", "0.0.0.0:8080", "--worker-class", "geventwebsocket.gunicorn.workers.GeventWebSocketWorker", "--no-control-socket", "--access-logfile", "-", "--error-logfile", "-", "app:app"]
